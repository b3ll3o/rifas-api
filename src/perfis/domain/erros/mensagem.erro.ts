export enum MensagemErro {
  ...
  PERMISSAO_NAO_ENCONTRADO = 'Permissão não encontrada',
  PERFIL_MODULO_NAO_ENCONTRADO = 'Modulo não encontrado no perfil',
  PERFIL_MODULO_PERMISSAO_JA_CADASTRADO = 'Permissão já adicionada ao modulo nesse perfil.'
}
